...
class NumberAcc_S : public edm::stream::EDProducer<> {
public:
    explicit NumberAcc_S(const edm::ParameterSet& config);
    ~NumberAcc_S() = default;
...
NumberAcc_S::NumberAcc_S(const edm::ParameterSet& config) :
...
void
NumberAcc_S::produce(edm::Event& event, const edm::EventSetup& setup)
{
...
void
NumberAcc_S::beginStream(edm::StreamID)
{
}

void
NumberAcc_S::endStream() {
}

void
NumberAcc_S::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  // NumberAcc_S
  edm::ParameterSetDescription desc;
  desc.add<edm::InputTag>("data", { "numberProducer" });
  descriptions.add("numberAcc_S", desc);
}

//define this as a plug-in
DEFINE_FWK_MODULE(NumberAcc_S);
